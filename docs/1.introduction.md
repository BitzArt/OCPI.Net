...
Once you're familiar with the basics, you can move on to the [Getting started with OCPI.Net](#getting-started-with-ocpinet) topic, which will guide you through the process of setting up a new project and using the package in your code.
