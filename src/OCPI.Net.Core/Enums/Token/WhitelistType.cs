...
public enum WhitelistType : byte
{
    /// <summary>
    /// Token always has to be whitelisted,
    /// realtime authorization is not possible/allowed.
    ...
    /// <summary>
    /// It is allowed to whitelist the token,
    /// realtime authorization is also allowed.
    ...
    /// But when the CPO cannot get a response from the eMSP
    ...
    /// CPO shall always send a realtime authorization
    /// for any use of this Token to the eMSP.
    /// </summary>
